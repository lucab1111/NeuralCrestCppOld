...
#define ARMA_USE_HDF5_ALT
  ...
  #define ARMA_HDF5_INCLUDE_DIR /usr/local/Cellar/hdf5/1.10.5_1/include/
#endif
...
#define ARMA_AUX_LIBS -framework Accelerate;/usr/local/lib/libhdf5.dylib;/usr/local/lib/libsz.dylib;/usr/lib/libz.dylib;/usr/lib/libdl.dylib;/usr/lib/libm.dylib;/usr/local/lib/libarpack.dylib
#define ARMA_AUX_INCDIRS /usr/local/Cellar/hdf5/1.10.5_1/include;/usr/local/opt/szip/include
