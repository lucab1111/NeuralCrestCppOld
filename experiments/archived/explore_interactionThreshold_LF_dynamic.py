...
follower_interactionThreshold_options = np.linspace(low_interactionThreshold, high_interactionThreshold, param_space_granularity)
leader_interactionThreshold_options = np.linspace(low_interactionThreshold, high_interactionThreshold, param_space_granularity)

for F_intThr in follower_interactionThreshold_options:
    for L_intThr in leader_interactionThreshold_options:

        combo = [leader_aMag, leader_De, L_intThr, 
        follower_aMag, follower_De, F_intThr]
